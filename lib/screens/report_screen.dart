        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: svc.reportContent!.contains('[Status:') 
            ...
            child: Row(
              children: [
                Icon(
                  svc.reportContent!.contains('[Status:') ? Icons.warning_amber : Icons.auto_awesome, 
                  color: svc.reportContent!.contains('[Status:') ? const Color(0xFF854D0E) : _teal, 
                  size: 20
                ),
                const SizedBox(width: 10),
                Expanded(
                  child: Text(
                    svc.reportContent!.contains('[Status:')
